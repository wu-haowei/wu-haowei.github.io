...
public partial class System_SatisfactionHis_Detail : BasePage
{
        ...
        if (!IsPostBack)
        {
            ...
            switch (state)
            {
                ...
                case "read":
                    ...
                    Comm_Case date = vw_Caseclosed.GetCase(id);
                    Satisfaction QuestionAnsdate = vw_Caseclosed.GetSatisfaction(id);
                    vw_Caseclosed vw_caseclosed = vw_Caseclosed.GetInstallationcomplete(id);
                    ...
                    if (date != null)
                    {
                        ...
                        txtDeptSN.Text = vw_caseclosed.DeptName;//合約院所
                        txtDoctorSN.Text = vw_caseclosed.Expr1;//負責醫生
                        txtCatregory.Text = vw_caseclosed.申請項目;//裝置項目
