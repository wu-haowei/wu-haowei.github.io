<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MP.master" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="System_SatisfactionHis_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <table class="Detail-table" width="100%">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtRemark" runat="server" Height="80px" Width="100%" TextMode="MultiLine" Enabled="False"></asp:TextBox>
                </td>
            </tr>
        </table>
    </asp:Panel>
