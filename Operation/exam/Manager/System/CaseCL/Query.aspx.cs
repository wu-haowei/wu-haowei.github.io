...
using System.Data;
using System.Text;
public partial class System_CaseCL_Query : BasePage
{

    protected void Page_Load(object sender, EventArgs e)
    {
        (this.Master.FindControl("litNav_Title") as Literal).Text = "已辦結案件";
    ...
    private void SetQparm()
    {
        ...
        odsIndex.SelectParameters["KeyWordPID"] = new Parameter("KeyWordPID", DbType.String, txtPID.Text);                          //申請人身分證字號
        odsIndex.SelectParameters["CaseType"] = new Parameter("CaseType", DbType.String, "CaseCL");                                 //案件管理類型
    }
