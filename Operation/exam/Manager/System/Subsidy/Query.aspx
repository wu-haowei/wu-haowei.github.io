<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MP.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="System_Subsidy_Query" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="ddlCategory" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Value="1">診治項目</asp:ListItem>
    ...
    <asp:GridViewHeadText ID="gvIndex" runat="server" CssClass="case-list-table" AutoGenerateColumns="False" DataKeyNames="SN"
        ...
        DataSourceID="odsIndex" odsSortReverse="False" OnSelectedIndexChanged="gvIndex_SelectedIndexChanged">
        <Columns>
            ...
            <asp:BoundField DataField="SN" HeaderText="項次" SortExpression="SN" HeaderStyle-HorizontalAlign="Center">
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                <HeaderStyle Width="10%"></HeaderStyle>
            </asp:BoundField>

            <asp:TemplateField HeaderText="補助類型">
                <ItemTemplate>
                    <asp:Label ID="lblCatregory" runat="server" Text='<%# GetCatregory(Convert.ToInt32( Eval("Catregory" ).ToString())) %>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="10%"></ItemStyle>
            </asp:TemplateField>

            <asp:BoundField DataField="Name" HeaderText="項目名稱" SortExpression="Status" HeaderStyle-HorizontalAlign="Center">
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                <HeaderStyle Width="10%"></HeaderStyle>
            </asp:BoundField>

            <asp:BoundField DataField="Amount" HeaderText="補助金額" SortExpression="Status" HeaderStyle-HorizontalAlign="Center">
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                <HeaderStyle Width="10%"></HeaderStyle>
            </asp:BoundField>
    ...
    <asp:ObjectDataSource ID="odsIndex" runat="server" SelectMethod="GetListData" SelectCountMethod="GetListCount"
        TypeName="Hamastar.BusinessObject.Comm_Subsidy" EnablePaging="True" StartRowIndexParameterName="startRowIndex"
