...
public partial class System_Subsidy_Query : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            btnAdd.PostBackUrl = string.Format("/System/Subsidy/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query));
    ...
    protected string GetCatregory(int Catregory)
    {
        switch (Catregory)
        {
            case 1:
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        CurrentConditions["Category"] = string.Empty;
    ...
    protected void gvIndex_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "btnRead":
                ...
                Response.Redirect(string.Format("/System/Subsidy/Detail.aspx{0}", Request.Url.Query));
                break;
    ...
    protected void gvIndex_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //編輯紐功能
            Comm_Subsidy Item = e.Row.DataItem as Comm_Subsidy;
    ...
    protected void odsIndex_Load(object sender, EventArgs e)
    {
        ...
        odsIndex.SelectParameters["Category"] = new Parameter("Category", DbType.String, this.ddlCategory.SelectedValue);

    }



    protected void gvIndex_SelectedIndexChanged(object sender, EventArgs e)
    {
