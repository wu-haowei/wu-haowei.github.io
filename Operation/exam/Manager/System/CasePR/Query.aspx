<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MP.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="System_CasePR_Query" %>
        ...
        <table class="search-box" style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlStatus" runat="server" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                        ...
                        <asp:ListItem Text="待審" Value="待審" />
                        <asp:ListItem Text="行政審查通過" Value="行政審查通過" />
                        <asp:ListItem Text="專業審查退件" Value="專業審查退件" />
                    </asp:DropDownList>
            ...
            <tr>
                <td style="text-align: right" colspan="4">
                    <asp:Button ID="btnMeetDate" runat="server" Text="指定開會時間" CssClass="btn" OnClick="btnMeetDate_Click" />
                    <asp:Button ID="btnAdd" runat="server" Text="＋新增個案" CssClass="btn" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <asp:GridViewHeadText ID="gvIndex" runat="server" CssClass="case-list-table" AutoGenerateColumns="False" DataKeyNames="CaseNo"
        ...
        <Columns>
            <asp:TemplateField HeaderText="勾選">
                <ItemTemplate>
                    <asp:CheckBox runat="server" ID="cbxSelect" CommandName="cbxSelect" CommandArgument='<%# (Eval("Status").Equals("待審")? "":Eval("CaseNo")) %>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="5%"></ItemStyle>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="功能">
                <ItemTemplate>
                    <asp:Button ID="btnEdit" runat="server" Text="修改" CssClass="img-btn edit" title="修改" CommandName="btnEdit" CommandArgument='<%# Eval("CaseNo") %>' />
            ...
            <asp:BoundField DataField="Status" HeaderText="案件狀態" SortExpression="Status" HeaderStyle-HorizontalAlign="Center">
                <HeaderStyle HorizontalAlign="Center" Width="10%" />
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
        </Columns>
