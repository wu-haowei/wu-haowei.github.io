...
public partial class System_Satisfaction_Query : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //btnAdd.PostBackUrl = string.Format("/System/Satisfaction/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query));
    ...
    protected void gvIndex_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "btnRead":
                ...
                Response.Redirect(string.Format("/System/Satisfaction/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query)));
                break;
        }
    }
    #endregion
    ...
    protected void gvIndex_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //編輯紐功能
            vw_Installationcomplete Item = e.Row.DataItem as vw_Installationcomplete;
    ...
    protected void odsIndex_Load(object sender, EventArgs e)
    {
        ...
        odsIndex.SelectParameters["DeptName"] = new Parameter("DeptName", DbType.String, DeptName.SelectedValue);
    }
    /// <summary>
    /// 取得全部院所名稱
    /// </summary>
