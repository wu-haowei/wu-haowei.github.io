...
public partial class System_RejectDesc_Query : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            btnAdd.PostBackUrl = string.Format("/System/RejectDesc/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query));
    ...
    protected void gvIndex_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "btnRead":
                ...
                Response.Redirect(string.Format("/System/RejectDesc/Detail.aspx{0}", Request.Url.Query));
                break;
        }
    }
    #endregion
    ...
    protected void gvIndex_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //編輯紐功能
            Comm_RejectDesc Item = e.Row.DataItem as Comm_RejectDesc;
