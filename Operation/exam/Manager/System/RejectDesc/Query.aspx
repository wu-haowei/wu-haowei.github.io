<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MP.master" AutoEventWireup="true" CodeFile="Query.aspx.cs" Inherits="System_RejectDesc_Query" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="ddlCategory" runat="server">
                                    ...
                                    <asp:ListItem Value="1">行政審核</asp:ListItem>
    ...
    <asp:GridViewHeadText ID="gvIndex" runat="server" CssClass="case-list-table" AutoGenerateColumns="False" DataKeyNames="SN"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="審核類型">
                <ItemTemplate>
            ...
            <asp:BoundField DataField="RejectDesc" HeaderText="退件事由" SortExpression="Status" HeaderStyle-HorizontalAlign="Center">
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                <HeaderStyle Width="10%"></HeaderStyle>
            </asp:BoundField>
    ...
    <asp:ObjectDataSource ID="odsIndex" runat="server" SelectMethod="GetListData" SelectCountMethod="GetListCount"
        TypeName="Hamastar.BusinessObject.Comm_RejectDesc" EnablePaging="True" StartRowIndexParameterName="startRowIndex"
