...
public partial class System_SatisfactionDis_Query : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //btnAdd.PostBackUrl = string.Format("/System/SatisfactionDis/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query));
            this.BindUI();
            AllDeptName();
        }
    }
    ...
    protected void gvIndex_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "btnRead":
                ...
                Response.Redirect(string.Format("/System/SatisfactionDis/Detail.aspx{0}", jSecurity.XSS(Request.Url.Query)));
                break;
        }
    }
    #endregion
