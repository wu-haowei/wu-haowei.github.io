<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MP.master" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="System_SatisfactionDis_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table class="Detail-table" width="100%">
            ...
            <tr runat="server" id="idRadioButtonList2">
                <td>
                    <asp:RadioButtonList ID="rdlQuestionAns4" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            ...
            <tr runat="server" id="idRadioButtonList3">
                <td>
                    <asp:RadioButtonList ID="rdlQuestionAns5" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
            ...
            <tr>
                <td>
                    <asp:RadioButtonList ID="rdlQuestionAns6" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="True" OnSelectedIndexChanged="rdlQuestionAns6_SelectedIndexChanged">
            ...
            <tr runat="server" id="idRadioButtonList5">
                <td>
                    <asp:RadioButtonList ID="rdlQuestionAns7" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="True">
    ...
    <table class="Detail-table" width="100%">
        ...
        <tr runat="server" id="tr_Dissatistrackoptions">
            <td>
                <%--不滿意後續追蹤--%>
                <asp:RadioButtonList ID="rblDissatistrackoptions" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            <td>
                <asp:CheckBoxList ID="cblHealthcenter" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                    <asp:ListItem Value="個案轉衛生所追蹤">個案轉衛生所追蹤</asp:ListItem>
                </asp:CheckBoxList>
            </td>
        </tr>
